 ...
 * using hfiles.
 */
public class PortDerivedDataGatherer extends KijiGatherer<HFileKeyValue, NullWritable> {

  private static final Logger LOG = LoggerFactory.getLogger(PortDerivedDataGatherer.class);
